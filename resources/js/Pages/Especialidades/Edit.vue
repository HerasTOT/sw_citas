...
const props = defineProps(['titulo', 'Especialidades', 'routeName']);
const form = useForm({ ...props.Especialidades });

const guardar = () => {
    form.put(route("especialidades.update", props.Especialidades.id));
};
    ...
    <LayoutMain :title="titulo">
        ...
        <CardBox form @submit.prevent="guardar">
            ...
            <FormField label="nombre">
                <FormControl v-model="form.nombre"  placeholder="Nombre de la especialidad"/>
            </FormField>
